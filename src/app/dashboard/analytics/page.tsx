      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 ">
              View Twitter analytics data for your clients
            </p>
          </div>
        ...
        {clients.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                You need to create at least one client to view analytics data.
              </p>
              <button
          ...
          <AnalyticsDashboard clientId={selectedClient} />
        ) : (
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <div className="text-center">
