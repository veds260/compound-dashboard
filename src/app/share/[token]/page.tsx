      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700 p-6 mb-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white mb-1">{post.client.name}</h1>
              {post.client.twitterHandle && (
                <p className="text-blue-400 text-base">@{post.client.twitterHandle}</p>
              )}
            </div>
          </div>

          {/* Status Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-900/50 border border-gray-700 backdrop-blur-sm">
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-6">
          ...
          <div className="lg:w-80 flex-shrink-0">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl font-semibold transition-all transform hover:scale-105 shadow-lg"
            >
        ...
        {/* Feedback */}
        {post.feedback && (
          <div className="bg-gradient-to-br from-yellow-900/30 to-yellow-800/20 border-2 border-yellow-600/50 rounded-2xl shadow-xl p-6 mb-6">
            <h3 className="text-xl font-bold text-yellow-300 mb-3 flex items-center gap-2">
              <PencilSquareIcon className="w-6 h-6" />
              Feedback:
            </h3>
            <p className="text-gray-100 whitespace-pre-wrap leading-relaxed">{post.feedback}</p>
          </div>
        )}
